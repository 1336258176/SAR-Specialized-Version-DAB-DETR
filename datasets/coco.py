...
def build(image_set, args):
    ...
    PATHS = {
        "train": (root / "images", root / "annotations" / "train2017.json"),
        "train_reg": (root / "images", root / "annotations" / "train2017.json"),
        "val": (root / "images", root / "annotations" / "test2017.json"),
        "eval_debug": (root / "images", root / "annotations" / "test2017.json"),
        "test": (root / "images", root / "annotations" / "test2017.json"),  # 实际没有使用
    }
